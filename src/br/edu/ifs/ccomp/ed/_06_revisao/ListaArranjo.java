...
public class ListaArranjo<T> implements Lista<T> {
	...
	/**
	 * Retorna a posição do elemento encontrado ou -1 caso não seja
	 * encontrado.
	 */
	@Override
	 ...
	 * 
	 * @return a posição do elemento removido ou -1 caso não seja
	 * encontrado.
	 */
	...
	/**
	 * Remove todas as ocorrências do elemento passado caso seja 
	 * encontrado.
	 * 
	 * @return a posição do elemento removido ou -1 caso não seja
	 * encontrado.
